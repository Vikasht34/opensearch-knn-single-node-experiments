...
# Constants
EXPERIMENT_PATH="experiments/binary-quantization-end-to-end-exp/exp-6"
...
aws s3 cp s3://knn-all-datasets/gist-960-euclidean.hdf5 /tmp/share-data/gist-960-euclidean.hdf5
