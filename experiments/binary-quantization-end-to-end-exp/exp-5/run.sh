...
# Constants
EXPERIMENT_PATH="experiments/binary-quantization-end-to-end-exp/exp-5"
...
aws s3 cp s3://knn-all-datasets/sift-128-euclidean.hdf5 /tmp/share-data/sift-128-euclidean.hdf5
