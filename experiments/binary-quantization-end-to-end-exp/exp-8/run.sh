...
# Constants
EXPERIMENT_PATH="experiments/binary-quantization-end-to-end-exp/exp-8"
...
aws s3 cp s3://knn-all-datasets/BIGANN-base.1B.u8bin /tmp/share-data/BIGANN-base.1B.u8bin
aws s3 cp s3://knn-all-datasets/BIGANN-public_query_gt100.bin /tmp/share-data/BIGANN-public_query_gt100.bin
aws s3 cp s3://knn-all-datasets/BIGANN-query.public.10K.u8bin /tmp/share-data/BIGANN-query.public.10K.u8bin
