...
# Constants
EXPERIMENT_PATH="experiments/binary-quantization-end-to-end-exp/exp-3"
...
aws s3 cp s3://knn-all-datasets/mpnet_marco_1.hdf5 /tmp/share-data/mpnet_marco_1.hdf5
